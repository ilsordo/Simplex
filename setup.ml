...
(* OASIS_START *)
(* DO NOT EDIT (digest: c1c7df2a84a16420cd2ea5281afb0337) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/nagaaym/Simplex";
          synopsis = "Simplex";
          description = Some [OASISText.Para "Simplex, Simplex; Simplex."];
          categories = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/nagaaym/Simplex.git";
                      src_repo_browser =
                        Some "https://github.com/nagaaym/Simplex";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("zarith", None)];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\232\221.~\246\247>\187\248\242m\211\020\253!\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
